...
let eigaon = new Skills("Eigaon", "attack", "curse", 30, 12, 1, 1, 0, "none", 0, "heavy curse damage to one foe");
...
let jokerSkills = [eiha, cleave, eigaon, dreamNeedle];
...
let mazio = new Skills("Mazio", "attack", "elec", 15, 10, 1, 3, 0, "none", 0, "light electric damage to all foes");
...
let skullSkills = [zio, lunge, mazio, headbutt];

/* Panther's skills */
let agi = new Skills("Agi", "attack", "fire", 15, 4, 1, 1, 0, "none", 0, "light fire damage to one foe");
let maragi = new Skills("Maragi", "attack", "fire", 15, 10, 1, 3, 0, "none", 0, "light fire damage to all foes");
...
let pantherSkills = [agi, dia, maragi, cleave];

/*Fox's skills*/
let bufu = new Skills("Bufu", "attack", "ice", 15, 4, 1, 1, 0, "none", 0, "light ice damage to one foe");
let mabufu = new Skills("Mabufu", "attack", "ice", 15, 10, 1, 3, 0, "none", 0, "light ice damage to all foes");
...
let foxSkills = [bufu, giantSlice, mabufu, visciousStrike];

/*Queen's skills*/
let frei = new Skills("Frei", "attack", "nuke", 15, 4, 1, 1, 0, "none", 0, "light nuclear damage to one foe");
let mafrei = new Skills("Mafrei", "attack", "nuke", 15, 10, 1, 3, 0, "none", 0, "light nuke damage to all foes");
...
let queenSkills = [frei, vajraBlast, diarama, mafrei];

/*Noir's skills*/
let psio = new Skills("Psio", "attack", "psy", 15, 4, 1, 1, 0, "none", 0, "light psychic damage to one foe");
let mapsio = new Skills("Mapsio", "attack", "psy", 15, 10, 1, 3, 0, "none", 0, "light psychic damage to all foes");
let snipe = new Skills("Snipe", "attack", "gun", 25, 10, 1, 1, 0, "none", 0, "medium gun damage to one foe");
let tripleDown = new Skills("Triple Down", "attack", "gun", 15, 25, 1, 3, 0, "none", 0, "light gun damage to all foes");
...
let noirSkills = [psio, tripleDown, mapsio, snipe];
...
let crowSkills = [megatonRaid, eiha, kouha, makouha];