...
charPanther = new Stats("panther", move, whip, pantherSkills, 100, 100, 50, 40, "fire", "ice");
charFox = new Stats("fox", move, katana, foxSkills, 100, 100, 50, 60, "ice", "fire");
charQueen = new Stats("queen", move, knuckles, queenSkills, 100, 100, 50, 45, "nuke", "psy");
charNoir = new Stats("noir", move, axe, noirSkills, 100, 100, 50, 30, "psy", "nuke");
charCrow = new Stats("crow", move, blaster, crowSkills, 100, 100, 50, 35, "bless", "curse");